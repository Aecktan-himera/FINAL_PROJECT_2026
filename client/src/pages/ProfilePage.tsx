...
const ProfilePage = () => {
  ...
  const [bio, setBio] = useState(
    "Люблю создавать красивые интерфейсы и решать сложные задачи.",
  );
  ...
  const handleSaveSettings = () => {
    ...
    localStorage.setItem(
      "profile_settings",
      JSON.stringify({ bgColor, stylePreset }),
    );
  };
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Верхняя секция: аватар + заголовок + кнопка "На главную" */}
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              <h1 className="text-3xl font-bold text-white drop-shadow-md">
                {user?.username || "Пользователь"} {user?.firstName || ""}{" "}
                {user?.surname || ""}
              </h1>
              {/* Кнопка "На главную" */}
              <button
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-white/50 mt-1">
                  Выберите основной цвет для элементов интерфейса
                </p>
              </div>
              <div>
                <label className="block text-white font-medium mb-1">
